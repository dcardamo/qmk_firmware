...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [_QWERTY] = LAYOUT_5x6(
     ...
     _______, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                        KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_BSLASH,
                      KC_LBRC,KC_RBRC,                                                       KC_PLUS, KC_EQL,
                         MT(MOD_LSFT, KC_ESC),KC_BSPC,                        LT(_RAISE, KC_SPC), MT(MOD_RCTL, KC_ENT),  // enter when tapped, control when held
  ...
  [_RAISE] = LAYOUT_5x6(
     ...
     _______,_______,LEFT_PAREN,KC_LBRACKET,LEFT_BRACE,_______,              KC_LEFT,KC_DOWN,KC_UP,KC_RGHT,_______,KC_VOLD,
     _______,_______,RIGHT_PAREN,KC_RBRACKET,RIGHT_BRACE,_______,             KC_MSTP,KC_MPRV,KC_MPLY,KC_MNXT,KC_VOLD,KC_MUTE,
