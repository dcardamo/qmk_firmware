...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------------+------+------+------+------+------+------+------+------+------+------+--+=====++------++======|
     * |  Ctrl  |   LAlt  |  Win  |               Space                  | RAlt |  Fn  | Ctrl || Left | Down | Rght |
     * `------------------------------------------------------------------------------------------------------------'
     */
    ...
    [_FN1] = LAYOUT(
        ...
        PRNCONF, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          RGB_TOG,
        ...
        _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, RGB_MOD, KC_MPLY,
        _______, _______, WINLOCK,                            _______,                            _______, _______, _______, RGB_SPD, RGB_RMOD,RGB_SPI
...
bool encoder_update_user(uint8_t index, bool clockwise) {
    ...
    if (mods_state & MOD_BIT(KC_RSFT)) { // If you are holding L shift, encoder changes layers
        encoder_action_layerchange(clockwise);
    } else if (mods_state & MOD_BIT(KC_LSFT)) { // If you are holding R shift, Page up/dn
        unregister_mods(MOD_BIT(KC_LSFT));
        encoder_action_navpage(clockwise);
        register_mods(MOD_BIT(KC_LSFT));
    } else if (mods_state & MOD_BIT(KC_LCTL)) { // if holding Left Ctrl, media next/prev track
